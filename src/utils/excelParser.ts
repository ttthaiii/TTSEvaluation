...
export const parseExcelFile = async (file: File, type: 'attendance' | 'leave' | 'warning' | 'other') => {
  ...
  if (type === 'attendance') {
    ...
    // DB_การลา, DB_ใบเตือน, และ Other: Header อยู่แถวแรกปกติ
...
export const validateData = (data: any[], type: 'attendance' | 'leave' | 'warning' | 'other') => {
